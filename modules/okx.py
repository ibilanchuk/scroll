...
class Okx(Account):
    ...
    def __init__(self, account_id: int, private_key: str, chains: List, recipient) -> None:
        super().__init__(account_id=account_id, private_key=private_key, chain=random.choice(chains), recipient=recipient)
